    ...
    <div>
      ...
      {lKpi ? <SkeletonKpis count={4} />
        ...
        <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', marginBottom: '24px' }}>
          ...
          <KpiCard titulo="Utilidad Bruta" valor={`$${Number(kpis.utilidadBruta).toLocaleString('es-CL')}`} color="#1a56db" sparkline={[400000,530000,390000,600000,540000,660000,850000]} />
