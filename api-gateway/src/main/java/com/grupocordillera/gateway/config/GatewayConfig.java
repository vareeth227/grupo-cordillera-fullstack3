...
public class GatewayConfig {
    ...
    @Value("${MS_VENTAS_URL:http://localhost:8081}")
    private String msVentasUrl;

    @Value("${MS_ECOMMERCE_URL:http://localhost:8082}")
    private String msEcommerceUrl;

    @Value("${MS_INVENTARIO_URL:http://localhost:8083}")
    private String msInventarioUrl;

    @Value("${MS_FINANCIERO_URL:http://localhost:8084}")
    private String msFinancieroUrl;

    @Value("${MS_CLIENTES_URL:http://localhost:8085}")
